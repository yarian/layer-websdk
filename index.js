...
layer.Identity = require('./src/identity').Identity;
layer.UserIdentity = require('./src/identity').UserIdentity;
layer.ServiceIdentity = require('./src/identity').ServiceIdentity;
